    ...
    if (sessionContext["new"]) {
      ...
      // add by kx
        ...
        var requestParm = {
            event: 'newDev',
            data: {
                id: sessionContext.deviceId,
                deviceId: rpcReq.deviceId,
                parameterList: rpcReq.parameterList,
                requestHeaders:  sessionContext.httpRequest.headers
            }
        };
        requestApiserver.postFormJson(requestApiserver.eventUrl.devNew, requestParm,  function(result) {
            //console.log("------------ request cwmp_event devNew-----------");
            //console.log(result);
            //console.log("------------------------------------------\n\n");
        })
        // kx add end
        ...
        requestApiserver.postFormJson(requestApiserver.eventUrl.inform, requestParm1,  function(result) {
           // console.log("------------ request cwmp_event inform-----------");
           // console.log(result);
           // console.log("------------------------------------------\n\n");
        });
        // kx add end
...
rpcResponse = function(sessionContext, id, rpcRes, callback) {
  ...
  // kx add
    ...
    for (channel in sessionContext.channels) {
      if(sessionContext.channels.hasOwnProperty(channel)){
   ...
   // console.log(rpcRes.name);
    requestApiserver.postFormJson(requestApiserver.eventUrl.rpcResponse, requestParams,  function(result) {
  ...
  switch (rpcRes.name) {
    ...
    case 'DownloadResponse':
        // kx add
        requestParams.data.status = rpcRes.status;
        // kx add end
